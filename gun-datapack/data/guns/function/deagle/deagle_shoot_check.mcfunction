...
execute if score @s ammo matches 1.. run function guns:deagle/deagle_shoot_d
...
tag @s add deagle_cooldown
execute as @s run schedule function guns:deagle/deagle_reset 16t append
