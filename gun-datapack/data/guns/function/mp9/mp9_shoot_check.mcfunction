...
execute if score @s ammo matches 1.. run function guns:mp9/mp9_shoot_d
...
tag @s add mp9_cooldown
execute as @s run schedule function guns:mp9/mp9_reset 2t append
