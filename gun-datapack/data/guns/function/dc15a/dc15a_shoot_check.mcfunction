...
execute if score @s ammo matches 1.. run function guns:dc15a/dc15a_shoot_d
...
tag @s add dc15a_cooldown
execute as @s run schedule function guns:dc15a/dc15a_reset 5t append
